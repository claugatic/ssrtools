...
#_ LO HI INIT PRIOR PR_SD PR_type PHASE env_var&link dev_link dev_minyr dev_maxyr dev_PH Block Block_Fxn
 ...
 40 90 70. 70 10 6 -4 0 0 0 0 0 0 0 # L_at_Amax_Fem_GP_1
 0.05 0.25 0.15 0.15 0.8 6 -4 0 0 0 0 0 0 0 # VonBert_K_Fem_GP_1
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn #  parm_name
             3            31           8.5          10.3            10             0          1          0          0          0          0          0          0          0 # SR_LN(R0)
...
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
            ...
            -7             5             0             0             1             0          -1          0          0          0          0          0          0          0  #  LnQ_base_SURVEY2(3)
...
#
#_          LO            HI          INIT         PRIOR         PR_SD       PR_type      PHASE    env-var    use_dev   dev_mnyr   dev_mxyr     dev_PH      Block    Blk_Fxn  #  parm_name
0.02	1	0.5	0.5	99 0	2	0	0	0	0	0	0	0
0.01	0.99	0.5	0.5	99 0	2	0	0	0	0	0	0	0
0.001	0.5	0.001	0.01	99 0	2	0	0	0	0	0	0	0
